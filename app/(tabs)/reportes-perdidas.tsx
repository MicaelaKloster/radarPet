...
// Componente principal para reportar mascotas perdidas
  ...
  return (
    ...
    <ThemedView style={styles.container}>
      ...
      <ThemedView style={styles.header}>
        {/* Ícono representativo de alerta/peligro para mascotas perdidas */}
        <IconSymbol
          size={40}
        ...
        <ThemedText style={styles.subtitle}>
          Ayúdanos a encontrar a tu mascota proporcionando la información más
          detallada posible
        </ThemedText>
      </ThemedView>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        {/* Primera sección: Información básica de la mascota */}
        <View style={styles.formSection}>
          ...
          <View style={styles.formField}>
            ...
            <View style={styles.inputPlaceholder}>
              <ThemedText style={styles.placeholderText}>
                Ej: Labrador, Mestizo, Siamés...
              </ThemedText>
            </View>
          </View>

          {/* Campo de texto largo para descripción física */}
          <View style={styles.formField}>
            <ThemedText style={styles.fieldLabel}>
              Descripción física
            </ThemedText>
            ...
            <View style={[styles.inputPlaceholder, styles.textAreaPlaceholder]}>
              <ThemedText style={styles.placeholderText}>
                Color, tamaño, señas particulares, collar, etc.
              </ThemedText>
            </View>
          </View>
        </View>

        {/* Segunda sección: Información de ubicación y tiempo */}
        <View style={styles.formSection}>
          <ThemedText type="subtitle" style={styles.sectionTitle}>
            Ubicación y Fecha
          </ThemedText>

          {/* Campo para la última ubicación conocida */}
          <View style={styles.formField}>
            <ThemedText style={styles.fieldLabel}>
          ...
          {/* Campo para fecha y hora de la pérdida */}
          <View style={styles.formField}>
            <ThemedText style={styles.fieldLabel}>
        ...
        <View style={styles.photoSection}>
          ...
          <View style={styles.photoPlaceholder}>
            ...
            <ThemedText style={styles.photoSubtext}>
              Una foto reciente ayudará a identificarla más fácilmente
            </ThemedText>
          </View>
        </View>
        ...
        <View style={styles.buttonContainer}>
          {/* Botón principal para publicar el reporte */}
...
const styles = StyleSheet.create({
  ...
  // Estilo para el título principal (color rojo para mascotas perdidas)
  title: {
    fontSize: 24, // Tamaño de fuente grande
    fontWeight: "bold", // Texto en negrita
    color: "#FF6B6B", // Color rojo característico para mascotas perdidas
  ...
  submitButton: {
    backgroundColor: "#FF6B6B", // Color rojo que coincide con el tema de mascotas perdidas
