...
export const EmailIcon = ({ width = 24, height = 24, color = '#fff' }: IconProps) => (
...
export const GoogleIcon = ({ width = 24, height = 24 }: IconProps) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
    <Path
...
export const LockIcon = ({ width = 24, height = 24, color = '#666' }: IconProps) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export const UserIcon = ({ width = 24, height = 24, color = '#666' }: IconProps) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
    <G stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const PhoneIcon = ({ width = 24, height = 24, color = '#666' }: IconProps) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
    <Path
...
export const MapIcon = ({ width = 24, height = 24, color = '#666' }: IconProps) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
    <Path
